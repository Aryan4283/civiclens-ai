...
*(Note: Copy and paste the contents of this document directly into your Google Doc for submission)*
...
*Insert: `01-landing-page.png`, `02-home-feed.png`, `03-register.png`, `04-login.png`*
...
*Insert: `06-report-upload.png`, `07-report-analysis.png`, `08-report-confirmed.png`*
...
*Insert: `09-issue-detail.png`, `10-issue-complaint.png`*
...
*Insert: `11-citizen-dashboard.png`*
...
*Insert: `12-fix-proof.png`, `13-before-after.png`*
...
- **AI Action Queue & Kanban Board:** A real-time, status-based Kanban board with dropdown controls that tracks incoming issues. The system automatically prioritizes tickets based on their AI-assigned severity score and SLA deadlines, ensuring critical emergencies never slip through the cracks.
  *Insert: `15-action-queue.png`, `19-kanban.png`*
...
- **The Civic Oracle (AI Predictive Reports):** A powerful AI report generator exclusively for government officials. By generating predictive reports, the Oracle analyzes city-wide data to detect recurring issues (e.g., repeating water leaks in the same ward) and forecasts future infrastructure failures, shifting the government from being *reactive* to *preventative*.
  *Insert: `17-oracle.png`, `18-city-report.png`*
...
- **Google Gen AI SDK (Gemini):** This is the core intelligence of the platform. We utilized `gemini-3.5-flash` to power four distinct agents:
  - **Observer Agent:** Utilizes True Function Calling (Structured JSON outputs) to process multi-modal image uploads and multilingual text input — citizens can describe issues in Hindi, Marathi, or any regional language; AI translates automatically.
  - **Router Agent:** Utilizes RAG (Retrieval-Augmented Generation) to analyze synthetic municipal policy documents (`sla_document.md`) and assign legal deadlines.
  - **QA Agent:** Performs comparative visual analysis between "before" and "after" photos.
  - **Custom Fallback Mesh:** We built a custom SDK wrapper that intercepts rate-limit errors and silently falls back to `gemini-3.1-flash-lite`, ensuring 100% uptime during evaluation.
